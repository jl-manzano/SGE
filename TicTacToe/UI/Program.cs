...
builder.WebHost.ConfigureKestrel(serverOptions =>
{
    ...
    // Esto permite conexiones desde localhost Y desde tu IP de red (192.168.1.129)
...
builder.Services.AddCors(options =>
{
    options.AddPolicy("AllowExpo", policy =>
    {
        policy.WithOrigins(
            ...
            "http://192.168.1.129:8081"  // ✅ Tu IP real
        )
        .AllowAnyHeader()
        .AllowAnyMethod()
        .AllowCredentials();
...
app.MapGet("/api/status", () => new
{
    ...
    networkUrl = "http://192.168.1.129:5251"  // ✅ Mostrar también la URL de red
});
...
Console.WriteLine("   📍 Red Local:  http://192.168.1.129:5251");
...
Console.WriteLine("   const HUB_URL = \"http://192.168.1.129:5251/gameHub\";");
Console.WriteLine();
